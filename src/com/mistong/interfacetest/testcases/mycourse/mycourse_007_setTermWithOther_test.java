...
/**
 * @接口     /api/request.do?msgId=20007
 * @描述               设置学习阶段、科目、教材版本对应关系
 * @author  YY
 * 
 */
public class mycourse_007_setTermWithOther_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(mycourse_007_setTermWithOther_test.class.getName());
