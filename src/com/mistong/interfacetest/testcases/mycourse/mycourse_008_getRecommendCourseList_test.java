...
/**
 * @接口     /api/request.do?msgId=20008
 * @描述               获取我的课堂课程推荐列表
 * @author  YY
 * 
 */
public class mycourse_008_getRecommendCourseList_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(mycourse_008_getRecommendCourseList_test.class.getName());
