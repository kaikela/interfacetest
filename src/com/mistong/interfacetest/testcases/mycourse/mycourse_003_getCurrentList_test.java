...
/**
 * @接口     /api/request.do?msgId=20003
 * @描述               获取教材版本列表 
 * @author  YY
 * 
 */
public class mycourse_003_getCurrentList_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(mycourse_003_getCurrentList_test.class.getName());
