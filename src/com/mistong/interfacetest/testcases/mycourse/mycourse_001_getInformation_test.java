...
/**
 * @接口     /api/request.do?msgId=20001
 * @描述               获取我的课堂信息（新）
 * @author  YY
 * 
 */
public class mycourse_001_getInformation_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(mycourse_001_getInformation_test.class.getName());
