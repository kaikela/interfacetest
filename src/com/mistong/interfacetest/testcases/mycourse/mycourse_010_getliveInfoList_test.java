...
/**
 * @接口     /api/request.do?msgId=20010
 * @描述               获取已购直播课列表
 * @author  YY
 * 
 */
public class mycourse_010_getliveInfoList_test extends BaseParpare {
	String memberId = null;
	int i = 0;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(mycourse_010_getliveInfoList_test.class.getName());
