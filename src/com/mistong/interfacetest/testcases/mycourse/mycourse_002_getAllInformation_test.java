...
/**
 * @接口     /api/request.do?msgId=20002
 * @描述               获取所有学习阶段与科目（新）
 * @author  YY
 * 
 */
public class mycourse_002_getAllInformation_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(mycourse_002_getAllInformation_test.class.getName());
