...
/**
 * @接口     /api/request.do?msgId=01004
 * @描述               激活学习卡
 * @author  wudingfei
 *
 */
public class studycard_001_activate_test extends BaseParpare {
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(studycard_001_activate_test.class
			.getName());
