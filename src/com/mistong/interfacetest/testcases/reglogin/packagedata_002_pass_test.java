...
/**
 * @接口     /api/request.do?msgId=01005(新接口)
 * @描述               根据年级获取套餐数据
 * @author  wudingfei
 *
 */
public class packagedata_002_pass_test extends BaseParpare {
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(packagedata_002_pass_test.class
			.getName());
