package com.mistong.interfacetest.testcases.update;
...
/**
 * @接口     /api/request.do?msgId=06001
 * @描述               软件更新
 * @author  wudingfei
 * 
 */
public class update_001_versionupdate_test extends BaseParpare {
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(update_001_versionupdate_test.class.getName());
