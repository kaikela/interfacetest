...
/**
 * @接口     /api/request.do?msgId=07003
 * @描述               移动端Banner新接口
 * @author  wudingfei
 * 
 */
public class generalize_003_appbannerlist_test extends BaseParpare {
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(generalize_003_appbannerlist_test.class.getName());
