...
/**
 * 接口   /api/request.do?msgId=03012
 * 描述  直播课程在线人数
 * @author YY
 *
 */
public class live_003_liveNum_test extends BaseParpare {
	
	//日志初始化   输出log
	static Logger logger = Logger.getLogger(live_003_liveNum_test.class.getName());
