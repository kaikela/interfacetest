...
/**
 * 接口   /api/request.do?msgId=03013
 * 描述  直播课列表
 * @author YY
 *
 */
public class live_004_liveList_test extends BaseParpare {
	
	//日志初始化   输出log
	static Logger logger = Logger.getLogger(live_004_liveList_test.class.getName());
