...
/**
 * @接口 /api/request.do?msgId=15003
 * @描述  移动端功能操作数据采集
 * @author wudingfei
 * 
 */

public class burypoint_003_functiondatagather_test extends BaseParpare {
	String memberId = null;
	String bannerId = null;
	int i = 0;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(burypoint_003_functiondatagather_test.class.getName());
