...
public class coursetest_009_answerofonClass_test extends BaseParpare{

	//日志初始化   输出log
	static Logger logger = Logger.getLogger(coursetest_009_answerofonClass_test.class.getName());
