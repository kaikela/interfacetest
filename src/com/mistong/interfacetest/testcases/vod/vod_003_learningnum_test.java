...
/**
 * @接口     /api/request.do?msgId=04003
 * @描述               学习人次接口
 * @author  wudingfei
 *
 */
public class vod_003_learningnum_test extends BaseParpare {
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(vod_003_learningnum_test.class
			.getName());
