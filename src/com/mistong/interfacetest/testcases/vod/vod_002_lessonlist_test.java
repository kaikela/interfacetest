...
/**
 * @接口     /api/request.do?msgId=04002
 * @描述               点播课获取课节列表
 * @author  wudingfei
 * 
 */
public class vod_002_lessonlist_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(vod_002_lessonlist_test.class
			.getName());
