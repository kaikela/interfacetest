...
public class DisEnabledCardsEwt {

	public static void main(String[] args) {
		HttpResponse<JsonNode> jsonResponse = null;
		JsonNode responseBody = null;
		boolean flag = true;
		String url, cardNoStart, cardNoEnd, tp, ticket;
		int cardCount;
		url = "http://bss.kaike.la/bss/cardEnabled/disEnabledCardsEwt.do";
		cardCount = 1;
		...
		try {
			jsonResponse = Unirest.post(url)
					...
					.field("cardNoEnd", cardNoEnd).field("tp", tp)
