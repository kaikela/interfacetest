...
/**
 * @接口 /api/request.do?msgId=16002
 * @描述   课程收藏
 * @author wudingfei
 * 
 */
public class coursecollection_002_collectioncourse_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(coursecollection_002_collectioncourse_test.class
			.getName());
