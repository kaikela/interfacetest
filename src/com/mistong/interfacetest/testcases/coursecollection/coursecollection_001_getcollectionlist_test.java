package com.mistong.interfacetest.testcases.coursecollection;
...
/**
 * @接口 /api/request.do?msgId=16001
 * @描述 课程收藏列表
 * @author wudingfei
 * 
 */
public class coursecollection_001_getcollectionlist_test extends BaseParpare {
	String memberId = null;
	int i = 0;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(coursecollection_001_getcollectionlist_test.class
					.getName());
	...
	public void startTest(ITestContext context) {
		...
		logger.info("清除收藏课程记录，请等待......");
		String del1;
		del1 = "delete from T_MEMBER_FAVORITE where MEMBER_ID ='" + memberId
				+ "'";
		DBHelper.executeNonQuery("ikukocesi", del1);
		logger.info("清除收藏课程记录完成");
	...
	public void testCase(Map<String, String> data) {
		...
		if (i == 4) {
			// 先收藏课程
			UnirestUtil.PostJson(
					"http://mobile.kaike.la/app/api/request.do",
					StrToMap("msgId:16002"), StrToJson("memberId:" + memberId
							+ ",commodityId:510"));
			// 执行接口测试(有收藏课程)
			UnirestUtil
					.InterfaceTest(
