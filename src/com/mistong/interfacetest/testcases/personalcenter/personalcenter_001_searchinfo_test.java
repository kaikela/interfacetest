...
/**
 * @接口     /api/request.do?msgId=05001
 * @描述               个人中心信息查询
 * @author  wudingfei
 * 
 */
public class personalcenter_001_searchinfo_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_001_searchinfo_test.class.getName());
