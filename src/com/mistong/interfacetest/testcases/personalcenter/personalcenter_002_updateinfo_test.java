...
/**
 * @接口     /api/request.do?msgId=05002
 * @描述               个人中心信息修改
 * @author  wudingfei
 * 
 */
public class personalcenter_002_updateinfo_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_002_updateinfo_test.class.getName());
