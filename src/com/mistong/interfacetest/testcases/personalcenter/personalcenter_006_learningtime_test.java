...
/**
 * @接口     /api/request.do?msgId=05006
 * @描述               学习时长
 * @author  wudingfei
 * 
 */
public class personalcenter_006_learningtime_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_006_learningtime_test.class.getName());
