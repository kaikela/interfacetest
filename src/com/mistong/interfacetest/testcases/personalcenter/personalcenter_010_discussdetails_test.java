...
/**
 * @接口 /api/request.do?msgId=05010
 * @描述 评论详情
 * @author wudingfei
 * 
 */
public class personalcenter_010_discussdetails_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_010_discussdetails_test.class.getName());
