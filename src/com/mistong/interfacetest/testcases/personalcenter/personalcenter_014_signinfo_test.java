...
/**
 * @接口 /api/request.do?msgId=05014
 * @描述 签到情况
 * @author wudingfei
 * 
 */
public class personalcenter_014_signinfo_test extends BaseParpare {
	String memberId = null;
	String talkId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_014_signinfo_test.class.getName());
