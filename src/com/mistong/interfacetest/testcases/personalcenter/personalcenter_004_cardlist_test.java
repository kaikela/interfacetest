...
/**
 * @接口     /api/request.do?msgId=05004
 * @描述               个人中心学习卡列表
 * @author  wudingfei
 * 
 */
public class personalcenter_004_cardlist_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_004_cardlist_test.class.getName());
