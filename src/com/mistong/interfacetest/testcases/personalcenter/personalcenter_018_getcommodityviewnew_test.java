...
/**
 * @接口     /api/request.do?msgId=05018
 * @描述               我的课程（新）
 * @author  wudingfei
 * 
 */
public class personalcenter_018_getcommodityviewnew_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_018_getcommodityviewnew_test.class.getName());
