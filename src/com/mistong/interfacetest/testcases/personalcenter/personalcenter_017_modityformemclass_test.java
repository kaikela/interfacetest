...
/**
 * @接口     /api/request.do?msgId=05017
 * @描述               个人中心信息修改（班级可修改）
 * @author  wudingfei
 * 
 */
public class personalcenter_017_modityformemclass_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_017_modityformemclass_test.class.getName());
