...
/**
 * @接口     /api/request.do?msgId=05020
 * @描述               会员积分查询
 * @author  wudingfei
 * 
 */
public class personalcenter_020_getmypoint_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_020_getmypoint_test.class.getName());
