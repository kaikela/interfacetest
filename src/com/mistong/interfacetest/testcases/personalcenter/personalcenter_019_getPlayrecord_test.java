...
/**
 * @接口     /api/request.do?msgId=05019
 * @描述              个人获取播放记录
 * @author  YY
 * 
 */
public class personalcenter_019_getPlayrecord_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_019_getPlayrecord_test.class.getName());
