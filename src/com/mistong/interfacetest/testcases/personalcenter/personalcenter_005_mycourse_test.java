...
/**
 * @接口     /api/request.do?msgId=05005
 * @描述               个人中心我的课程
 * @author  wudingfei
 * 
 */
public class personalcenter_005_mycourse_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger
			.getLogger(personalcenter_005_mycourse_test.class.getName());
