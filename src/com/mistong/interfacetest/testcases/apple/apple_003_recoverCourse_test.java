...
/**
 * @接口 /api/request.do?msgId=10003
 * @描述  IOS匿名登录恢复已购买课程
 * @author YY
 * 
 */
public class apple_003_recoverCourse_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(apple_003_recoverCourse_test.class
			.getName());
