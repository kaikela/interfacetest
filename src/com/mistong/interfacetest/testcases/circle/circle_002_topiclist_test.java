...
/**
 * @接口 /api/request.do?msgId=12002
 * @描述 主题帖列表
 * @author wudingfei
 * 
 */
public class circle_002_topiclist_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(circle_002_topiclist_test.class
			.getName());
