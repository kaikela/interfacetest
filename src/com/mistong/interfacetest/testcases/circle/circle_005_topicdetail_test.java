...
/**
 * @接口 /api/request.do?msgId=12005
 * @描述 主题贴详情
 * @author wudingfei
 * 
 */

public class circle_005_topicdetail_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(circle_005_topicdetail_test.class
			.getName());
