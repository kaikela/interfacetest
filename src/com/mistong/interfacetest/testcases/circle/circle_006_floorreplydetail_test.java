...
/**
 * @接口 /api/request.do?msgId=12006
 * @描述  回复评论详情（校园那些事、师生关系圈、兴趣交流圈）
 * @author wudingfei
 * 
 */

public class circle_006_floorreplydetail_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(circle_006_floorreplydetail_test.class
			.getName());
