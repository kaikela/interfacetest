...
/**
 * @接口 /api/request.do?msgId=12004
 * @描述 师生关系圈“送花”操作
 * @author wudingfei
 * 
 */

public class circle_004_flower_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(circle_004_flower_test.class
			.getName());
	...
	public void startTest(ITestContext context) {
		...
		logger.info("清除当天的鲜花数据，请等待......");
		String del1;
		del1 = "delete from T_CIRCLE_EVENT where date_format(CREATE_DATE,'%y-%m-%d') = curdate() and MEM_ID = "
				+ memberId;
		DBHelper.executeNonQuery("ikukocesi", del1);
		logger.info("清除当天的鲜花数据完成");
