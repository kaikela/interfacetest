...
/**
 * @接口 /api/request.do?msgId=12007
 * @描述  主题帖发表（校园那些事、师生关系圈、兴趣交流圈）
 * @author wudingfei
 * 
 */

public class circle_007_publishtopic_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(circle_007_publishtopic_test.class
			.getName());
	...
	public void startTest(ITestContext context) {
		...
		String del1;
		del1 = "delete from T_CIRCLE_TOPIC where TITLE = 'test'";
