...
/**
 * @接口 /api/request.do?msgId=12001
 * @描述 圈子首页列表
 * @author wudingfei
 * 
 */
public class circle_001_firstpagelist_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(circle_001_firstpagelist_test.class
			.getName());
