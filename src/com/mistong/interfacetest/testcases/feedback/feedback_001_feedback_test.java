package com.mistong.interfacetest.testcases.feedback;
...
/**
 * @接口     /api/request.do?msgId=08001
 * @描述               意见反馈
 * @author  wudingfei
 *
 */
public class feedback_001_feedback_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(feedback_001_feedback_test.class
			.getName());
