...
/**
 * @接口 /api/request.do?msgId=11009
 * @描述 修改密码
 * @author wudingfei
 * 
 */
public class payment_009_chargepassword_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(payment_009_chargepassword_test.class
			.getName());
