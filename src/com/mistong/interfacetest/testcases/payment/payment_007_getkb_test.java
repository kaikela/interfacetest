...
/**
 * @接口 /api/request.do?msgId=11007
 * @描述 KB查询
 * @author wudingfei
 * 
 */
public class payment_007_getkb_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(payment_007_getkb_test.class
			.getName());
