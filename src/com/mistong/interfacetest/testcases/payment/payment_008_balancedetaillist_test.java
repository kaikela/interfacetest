...
/**
 * @接口 /api/request.do?msgId=11008
 * @描述 余额明细列表
 * @author wudingfei
 * 
 */
public class payment_008_balancedetaillist_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(payment_008_balancedetaillist_test.class
			.getName());
