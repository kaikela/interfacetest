 ...
 * 
 */
public class fm_009_growupList_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(fm_009_growupList_test.class
			.getName());
