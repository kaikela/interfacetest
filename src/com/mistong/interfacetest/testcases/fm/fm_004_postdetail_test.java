...
/**
 * @接口 /api/request.do?msgId=13004
 * @描述  心理FM评论回复详情
 * @author wudingfei
 * 
 */

public class fm_004_postdetail_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(fm_004_postdetail_test.class
			.getName());
