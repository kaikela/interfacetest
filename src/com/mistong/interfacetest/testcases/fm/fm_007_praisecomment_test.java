...
/**
 * @接口 /api/request.do?msgId=13007
 * @描述 心理FM评论点赞
 * @author wudingfei
 * 
 */

public class fm_007_praisecomment_test extends BaseParpare {
	String memberId = null;
	// 输出本页面日志 初始化
	static Logger logger = Logger.getLogger(fm_007_praisecomment_test.class
			.getName());
	...
	public void startTest(ITestContext context) {
		...
		String del1;
		del1 = "delete from fm_posts_up_info where date_format(CREATE_DATE,'%y-%m-%d') = curdate() ";
